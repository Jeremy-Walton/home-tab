...
const fieldLegendVariants = cva(styles.fieldLegend, {
  variants: {
    variant: {
      legend: styles.fieldLegendLegend,
      label: styles.fieldLegendLabel,
    },
  },
  defaultVariants: {
    variant: 'legend',
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div data-slot="field-label" className={cn(styles.fieldTitle, className)} {...props} />
  )
}
...
function FieldError({
  ...
  return (
    <div role="alert" data-slot="field-error" className={cn(styles.fieldError, className)} {...props}>
      {content}
    </div>
  )
}
